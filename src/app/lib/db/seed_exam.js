...
const insert = db.prepare(`
  INSERT INTO exam (id, name, description, mp3, image, time_min, active)
  VALUES (@id, @name, @description, @mp3, @image, @time_min, @active)
`);

// Prevent double seeding
const { count } = db
  .prepare("SELECT COUNT(*) AS count FROM exam")
  .get();
