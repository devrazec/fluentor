...
export default function DashboardLayout({ children }) {
    ...
    const { darkMode, setDarkMode, mobileDevice,
        setMobileDevice,
        dbCategory, setDbCategory,
        dbTense, setDbTense,
        dbQuestion,
        setDbQuestion,
        dbAnswer,
        ...
        setSelectedQuestion,
        selectedAnswer,
        setSelectedAnswer, } = useContext(GlobalContext);
    ...
    const drawerContent = (
        <Box sx={{ pl: 2, pr: 2, position: 'relative', height: '100%' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: desktopOpen ? 'space-between' : 'center', mb: 0, px: 1, py: 1 }}>
        ...
        <Box sx={{ display: 'flex', minHeight: '100vh' }}>
            ...
            >
                ...
                >
                    ...
                    <Typography variant="h6" fontWeight={700} sx={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', pointerEvents: 'none' }}>
                        {pageTitle}
                    </Typography>
                    ...
                    <Box sx={{ display: 'flex', gap: 1 }}>
                        ...
                        >
                            {darkMode ? <Sun1 variant="Bulk" color="#00a76f" /> : <Moon variant="Bulk" color="#00a76f" />}
                        </IconButton>
                        {/* <IconButton>
    ...
    return (
        <ListItemButton
            ...
            sx={{
                ...
                '& .MuiListItemIcon-root': { color: active ? '#00a76f' : 'inherit', minWidth: open ? undefined : 0 },
                '&:hover': { backgroundColor: active ? 'rgba(0, 167, 111, 0.18)' : undefined },
            }}
        >
            <ListItemIcon>{icon}</ListItemIcon>
            {open && <ListItemText primary={text} primaryTypographyProps={{ fontWeight: active ? 700 : 400 }} />}
        </ListItemButton>
    );
}
